 ...
 */
class KenoDraws extends BaseModel
{
    use \think\model\concern\SoftDelete;

    protected $deleteTime = 'deleted_at';
    protected $connection = 'mysql';
    protected $table = 'game_keno_draws';
    ...
    {
        return $this->hasMany(KenoBets::class, 'period_number', 'period_number');
    }
}
